...
public class MemberController {
	...
	@PostMapping("/join")
	public ModelAndView joinMember(SignUpRequest signUpRequest, RedirectAttributes redirectAttributes) throws IOException {
		boolean isRegistered  = memberService.joinMember(signUpRequest);
...
//		member.setNo(no);
	...
	@PutMapping("/{no}")
	public ModelAndView editMember(SignUpRequest signUpRequest) {
		boolean isEdited = memberService.editMember(signUpRequest);
		Integer id = null;
		...
		return new ModelAndView(new RedirectView("/member/" + id + "/form"));
	}
